...
Shown here:
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_server.png)
In GNURadio Companion:
...
Shown here:
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_client.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_server_before.png)
...
Your GUI window should look like this:
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_freq_slider.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_server_after.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_client_streaming_add_GUI.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_server_streaming_add_ZMQ.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_client_streaming_add_ZMQ.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Xmlrpc_client_streaming_complete.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Guild_navigator_fm.png)
