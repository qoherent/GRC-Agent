...
[](https://wiki.gnuradio.org/index.php?title=File:SignalSourceStreamExample.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:StreamVectorDarkerColors.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:TwoSignalSourceBlocks.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ChangeFrequencyAmplitudeSignalSource.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ConnectStreamsToVector.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:InterleavedSignalSourceWithTimeSinks.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:TimeSinkAProperty.png)
[](https://wiki.gnuradio.org/index.php?title=File:SignalSourceATimeSink.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:TimeSinkBProperty.png)
[](https://wiki.gnuradio.org/index.php?title=File:SignalSourceBTimeSink.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:TimeSinkInterleavedProperty.png)
[](https://wiki.gnuradio.org/index.php?title=File:InterleavedSignalSourceTimeSink.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:TimeSinkSignalSources.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddVectorToStreamsBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:DeleteTimeSinks.png)

Move and reconnect the two _QT GUI Time Sink_ blocks to the _Vector to Streams_ outputs:
[](https://wiki.gnuradio.org/index.php?title=File:ReconnectedTimeSinks.png)

Run the flowgraph. The vectorized samples have been separated back into two streams:
[](https://wiki.gnuradio.org/index.php?title=File:DeserializedTimeSink.png)
