...
[](https://wiki.gnuradio.org/index.php?title=File:MessageBlockExample.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:StartingFlowgraphMessagePassing.png)
## Multiplexer: Defining The Block
Double-click the _Embedded Python Block_ and open the source in the editor:
[](https://wiki.gnuradio.org/index.php?title=File:EditMultiplexerProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddSecondInputEmbeddedPythonBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:TabsSpacesError.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultiplexerWithTwoInputs.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddMessageHandler.png)

Save the code. Notice that errors are listed in the properties of the _Embedded Python Block_ :
[](https://wiki.gnuradio.org/index.php?title=File:CodeEditorErrorExample.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ImportPMT.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddSelectorAttribute.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultiplexerWorkFunction.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:CompletedMultiplexerBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultiplexerNoiseInput.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddPythonBlockToFlowgraph.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ReplaceExampleParamWithNumSamples.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddControlSelectorMessageOutput.png)

Save the code and return to GRC. The _Selector Control_ block has a message output port:
[](https://wiki.gnuradio.org/index.php?title=File:MessageOutputSelectorControlBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:DefineCounterInBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:CompletedSelectorControlBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:SelectorControlProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MessageDebugExample.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ConnectMessagePorts.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MessageVirtualSourceSink.png)

Run the flowgraph. The _QT GUI Time Sink_ shows an alternating output between the _Noise Source_ and _Signal Source_ :
[](https://wiki.gnuradio.org/index.php?title=File:AlternatingOutputTimeSink.png)
