...
## Transmitting
[](https://wiki.gnuradio.org/index.php?title=File:Ofdm_tx_core.png)Core elements of an OFDM transmitter
...
[](https://wiki.gnuradio.org/index.php?title=File:Ofdm_rx_core.png)Core elements of an OFDM receiver
...
[](https://wiki.gnuradio.org/index.php?title=File:OFDM_loopback_BER_fg.png)
