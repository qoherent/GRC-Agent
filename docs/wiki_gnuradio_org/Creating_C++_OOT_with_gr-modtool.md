...
[](https://wiki.gnuradio.org/index.php?title=File:ReloadBlockLibrary.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultDivBlockLibrary.png)
Drag the _multDivSelect_ block into the flowgraph:
[](https://wiki.gnuradio.org/index.php?title=File:AddMultDivToWorkspace.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultDivFlowgraph.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultDivMultOutput.png)
Edit the properties of the _multDivSelect_ block and enter _False_ for the _selector_ :
[](https://wiki.gnuradio.org/index.php?title=File:MultDivProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:MultDiv_DivOutput.png)
## Making Changes
