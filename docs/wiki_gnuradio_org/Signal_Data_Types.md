...
[](https://wiki.gnuradio.org/index.php?title=File:GRCDataTypesHelp.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ExamplePortColors.png)
## Complex Data Type
...
[](https://wiki.gnuradio.org/index.php?title=File:FlowgraphWithComplexDataTypes.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:FlowgraphTimeSinkComplex.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:SignalSourceDataTypes.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:RealToComplexConnectionError.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:BlockSelected.png)

The flowgraph is complete after all data types have been converted to _Float_ :
[](https://wiki.gnuradio.org/index.php?title=File:FlowgraphWithRealDataTypes.png)

The _Signal Source_ block creates a real output, which is displayed as the only signal in the time domain:
[](https://wiki.gnuradio.org/index.php?title=File:RealSignalTimeSink.png)
