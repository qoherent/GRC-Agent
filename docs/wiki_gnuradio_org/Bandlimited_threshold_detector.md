...
[](https://wiki.gnuradio.org/index.php?title=File:Whole_flowgraph.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Synth_spectrum.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Two_vert_one_horiz_vectors.png)
The parameters for the 3 Vector Source blocks are shown here:
[](https://wiki.gnuradio.org/index.php?title=File:Adjustable_threshold_vector.png) [](https://wiki.gnuradio.org/index.php?title=File:Adjustable_upper_bound_vector.png) [](https://wiki.gnuradio.org/index.php?title=File:Adjustable_lower_bound_vector.png)
`fft_size` = 8192
...
[](https://wiki.gnuradio.org/index.php?title=File:Low_bound_vec_top_half.png)
[](https://wiki.gnuradio.org/index.php?title=File:Low_bound_vec_bottom_half.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Synth_signal_logpwrfft.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Synth_signal_two_vert_one_horiz_GUI_GIF.gif)
#### Detection
...
[](https://wiki.gnuradio.org/index.php?title=File:Synth_signal_spectrum_inside_upper_lower.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:In_box_spec_len.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Between_upper_lower_detect.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:All_spectrum_in_freq_bound_box.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Detection_logic.png)
The output is a vector where every index is greater than or equal to the threshold value.
[](https://wiki.gnuradio.org/index.php?title=File:Threshold_xings.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Detection_file_write_embedded_block.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Freq_bound_thresh_complete_demo_with_fileoutput.gif)
