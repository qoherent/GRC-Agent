...
[](https://wiki.gnuradio.org/index.php?title=File:FlowgraphFrequencyXlatingFilterStart.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:LowPassFilterTapsProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:LowPassFilterTapsTuple.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:LowPassFilterTapsFreqSink.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:LowPassFilterTapsMaxHold.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:AddImportBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:ImportProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:BoxcarFilterTaps.png)

Right-click on _Low-Pass Filter Taps_ and then _Disable_ :
[](https://wiki.gnuradio.org/index.php?title=File:DisableLowPassFilterTaps.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:UpdateXlatingFilterTaps.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:BoxcarFilterMaxHold.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:DeleteBoxcarFilterVariable.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:NVariable.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:FrequencyShiftVariable.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:BandPassTapsVariable.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:SelectRealInputComplexOutput.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:RealSignalSource.png)
The flowgraph looks like:
[](https://wiki.gnuradio.org/index.php?title=File:RealToComplexFlowgraph.png)
Run the flowgraph, turn on _Max Hold_ , and sweep the _frequency_ variable:

[](https://wiki.gnuradio.org/index.php?title=File:RealToComplexMaxHold.png)
