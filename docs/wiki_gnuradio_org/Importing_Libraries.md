...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_import_block.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_import_statement.png)

The **Import** block then displays the imported library as _np_.
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_after_numpy_import.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_numpy_import_in_python.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_sequential_array_variable.png)

The _sequentialArray_ variable is then manipulated by the _reversedArray_ variable, reversing the order of the array:
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_reversed_array_variable.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_random_amplitude_variable.png)

Add a Signal Source to the flowgraph and use the randomAmplitude variable as the Amplitude:
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_signal_source_random_amplitude.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_random_amplitude_flowgraph.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_random_amplitude_in_python.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_random_amplitude_example_1.png)
[](https://wiki.gnuradio.org/index.php?title=File:Importing_libraries_random_amplitude_example_2.png)
