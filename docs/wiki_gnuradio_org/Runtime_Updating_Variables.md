...
[](https://wiki.gnuradio.org/index.php?title=File:SearchQTGUIRange.png)
Drag and drop the _QT GUI Range_ block into the workspace:
[](https://wiki.gnuradio.org/index.php?title=File:DragDropQTGUIRange.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:SetRangeProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:DisableVariableBlock.png)
The block is now ignored and the error is resolved.
[](https://wiki.gnuradio.org/index.php?title=File:VariableBlockDisabled.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:QTGUIRangeDefaultValue.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:QTGUIRangeDragSlider.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:QTGUIChooserLibraryBlock.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:QTGUIChooserUpdateProperties.png)
...
[](https://wiki.gnuradio.org/index.php?title=File:QTGUIChooserDefaultValue.png)

The values are selected by clicking on the drop-down menu. Click on _Frequency: 1000_ :
[](https://wiki.gnuradio.org/index.php?title=File:SelectFromQTGUIChooser.png)

The updated frequency is seen in the frequency spectrum:
[](https://wiki.gnuradio.org/index.php?title=File:QTGUIChooserOptionSelected.png)
