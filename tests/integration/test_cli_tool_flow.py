...
class CliToolFlowIntegrationTests(unittest.TestCase):
    ...
    def test_debug_bundle_command_writes_redacted_bundle(self) -> None:
        ...
        self.assertIn("mode", bundle["environment"])
        self.assertIn("runtime", bundle["gnu_radio"])
        self.assertIn("grcc_path", bundle["gnu_radio"]["runtime"])
        self.assertIn("gnuradio_import_ok", bundle["gnu_radio"]["runtime"])
