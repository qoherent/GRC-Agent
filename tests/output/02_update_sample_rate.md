# 02 Update Sample Rate

**Scenario:** `02_update_sample_rate` | **Fixture:** `dial_tone.grc` | **Model:** `qwen3.6:35b-a3b-q4_K_M`
...
```text
Inspect the current flowgraph. Then update the `samp_rate` variable to `48000`. Confirm the change by inspecting again.
```
...
```json
{"ok": true, "graph": {"graph_name": "dial_tone", "blocks": [{"instance_name": "samp_rate", "block_id": "variable", "role": "variable", "state": "enabled", "params": {"value": "48000"}, "inputs": [], "outputs": [], "omitted_params_count": 2, "omitted_inputs_count": 0, "omitted_outputs_count": 0}], "connections": [], "validation": {"status": "valid", "errors": []}}}
```
...
{
  "ok": true,
  "assistant_text": "The `samp_rate` variable has been successfully updated from `32000` to `48000`. The graph remains valid after this change.",
  "expect_reason": "ok"
}
```
