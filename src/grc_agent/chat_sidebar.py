...
class ChatSidebar(StreamViewMixin, TranscriptViewMixin, ComposerMixin, Gtk.Box):
    ...
    (rendering completed turns), and ``ComposerMixin`` (input area,
    attachments, send) are U15 splits; each shares this one instance's
    attributes by convention, not encapsulation — an organizational split of
    a genuinely single widget.
    """
