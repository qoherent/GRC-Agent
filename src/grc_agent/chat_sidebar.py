...
class ChatSidebar(StreamViewMixin, Gtk.Box):
    ...
    ``StreamViewMixin`` (U15) owns the live-streaming render; it and
    ``ChatSidebar`` share one instance's attributes by convention, not
    encapsulation — an organizational split of a genuinely single widget.
    """
