...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "20. For direct GNU Radio how/why questions about DSP concepts, PMTs, tags, packet framing, sample-rate math, hardware scaling, tutorials, or diagnostics that do not require the current graph, use `search_manual` before answering. "
